...
const RenderActionCollectionState = React.memo((props) => {
  ...
  $[0] !== actionProps.id || $[1] !== children ? (t0 = (t12) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(ActionsGuardWrapper, { states, documentId: actionProps.id, children });
  }, $[0] = actionProps.id, $[1] = children, $[2] = t0) : t0 = $[2];
  let t1;
  return $[3] !== actionProps || $[4] !== actions || $[5] !== group || $[6] !== onActionComplete || $[7] !== t0 ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(sanity.GetHookCollectionState, { onReset: onActionComplete, hooks: actions, args: actionProps, group, children: t0 }), $[3] = actionProps, $[4] = actions, $[5] = group, $[6] = onActionComplete, $[7] = t0, $[8] = t1) : t1 = $[8], t1;
});
RenderActionCollectionState.displayName = "Memo(RenderActionCollectionState)";
const ActionsGuardWrapper = (props) => {
  const $ = reactCompilerRuntime.c(9), {
    states,
    children
  } = props;
