...
const DEFAULT_OVERRIDEABLE_FIELDS = [
  ...
  extend(subTypeDef, extendMember) {
    const parsed = Object.assign(pick(ANY_CORE, OVERRIDABLE_FIELDS$f), subTypeDef, {
      type: ANY_CORE,
    ...
    function subtype(parent) {
      return {
        ...
        extend: (extensionDef) => {
          ...
          const current = Object.assign({}, parent, pick(extensionDef, OVERRIDABLE_FIELDS$f), {
            type: parent
          });
...
const OVERRIDABLE_FIELDS$d = [...DEFAULT_OVERRIDEABLE_FIELDS], BOOLEAN_CORE = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick(BOOLEAN_CORE, OVERRIDABLE_FIELDS$d), subTypeDef, {
      type: BOOLEAN_CORE,
...
const CrossDatasetReferenceType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick(DATE_CORE, OVERRIDABLE_FIELDS$b), subTypeDef, {
      type: DATE_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick(DATETIME_CORE, OVERRIDABLE_FIELDS$a), subTypeDef, {
      type: DATETIME_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
...
const OVERRIDABLE_FIELDS$9 = [
  ...
  extend(rawSubTypeDef, createMemberType) {
    const subTypeDef = { fields: [], ...rawSubTypeDef }, options = { ...subTypeDef.options || {} }, parsed = Object.assign(pick(this.get(), OVERRIDABLE_FIELDS$9), subTypeDef, {
      type: this.get(),
...
const DOCUMENT_CORE = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick(EMAIL_CORE, OVERRIDABLE_FIELDS$8), subTypeDef, {
      type: EMAIL_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
