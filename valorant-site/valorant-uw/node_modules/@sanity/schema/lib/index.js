...
const DEFAULT_OVERRIDEABLE_FIELDS = [
  ...
  "initialValue",
  "deprecated"
], OVERRIDABLE_FIELDS$f = [...DEFAULT_OVERRIDEABLE_FIELDS], ANY_CORE = {
  name: "any",
  type: null,
  jsonType: "any"
}, AnyType = {
  ...
  extend(subTypeDef, extendMember) {
    const parsed = Object.assign(pick__default.default(ANY_CORE, OVERRIDABLE_FIELDS$f), subTypeDef, {
      type: ANY_CORE,
    ...
    function subtype(parent) {
      return {
        ...
        extend: (extensionDef) => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$f), {
            type: parent
          });
...
const OVERRIDABLE_FIELDS$e = [...DEFAULT_OVERRIDEABLE_FIELDS], ARRAY_CORE = {
  name: "array",
  type: null,
  jsonType: "array",
  of: []
...
const OVERRIDABLE_FIELDS$d = [...DEFAULT_OVERRIDEABLE_FIELDS], BOOLEAN_CORE = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(BOOLEAN_CORE, OVERRIDABLE_FIELDS$d), subTypeDef, {
      type: BOOLEAN_CORE,
...
const CrossDatasetReferenceType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(DATE_CORE, OVERRIDABLE_FIELDS$b), subTypeDef, {
      type: DATE_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(DATETIME_CORE, OVERRIDABLE_FIELDS$a), subTypeDef, {
      type: DATETIME_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
...
const OVERRIDABLE_FIELDS$9 = [
  ...
  extend(rawSubTypeDef, createMemberType) {
    const subTypeDef = { fields: [], ...rawSubTypeDef }, options = { ...subTypeDef.options || {} }, parsed = Object.assign(pick__default.default(this.get(), OVERRIDABLE_FIELDS$9), subTypeDef, {
      type: this.get(),
...
const DOCUMENT_CORE = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(EMAIL_CORE, OVERRIDABLE_FIELDS$8), subTypeDef, {
      type: EMAIL_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
