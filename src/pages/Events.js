...
function Events() {
    ...
    return (
      <>
        <div className="relative max-w-full overflow-hidden bg-contain bg-repeat flex justify-center" style={{ backgroundImage: `url(${dotOverlay})` }}>
          <div className="relative w-full overflow-hidden max-w-[90rem] px-[auto]">
